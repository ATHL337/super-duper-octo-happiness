...
int main() {
 ...
 if (fgets(input, sizeof(input), stdin) != NULL) {
  strncpy(input, input, sizeof(input) - 1);
  // remove the newline character
  input[strlen(input) - 1] = 0;
  
  char bandera[] = {0x66, 0x6c, 0x61, 0x67, 0x7b, 0x66, 0x66, 0x34, 0x31, 0x61, 0x31, 0x64, 0x30, 0x30, 0x33, 0x30, 0x39, 0x31, 0x65, 0x31, 0x39, 0x39, 0x63, 0x33, 0x30, 0x37, 0x64, 0x39, 0x38, 0x63, 0x62, 0x31, 0x65, 0x38, 0x35, 0x64, 0x38, 0x7d};
